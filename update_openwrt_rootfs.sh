...
curl -sL https://downloads.openwrt.org/snapshots/targets/armvirt/64/openwrt-armvirt-64-default-rootfs.tar.gz | docker buildx import --platform=arm64 - kayuii/openwrt-rootfs:armvirt64
docker push kayuii/openwrt-rootfs:armvirt64

curl -sL https://downloads.openwrt.org/releases/19.07.4/targets/armvirt/64/openwrt-19.07.4-armvirt-64-default-rootfs.tar.gz | docker buildx import --platform=arm64 - kayuii/openwrt-rootfs:armvirt64-19.07.4
